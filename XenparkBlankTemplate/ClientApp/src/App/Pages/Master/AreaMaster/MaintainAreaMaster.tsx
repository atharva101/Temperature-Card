...
const MaintainAreaMaster = (props: IMaintainMasterProps) => {
    ...
    useEffect(() => {
        props.fetchParentData('block', true);
    }, []);
    ...
    return (<>
        <Row>
            <Col>
                <Card>
                    <Card.Header>
                        <Card.Title as="h5">{isEdit ? 'Edit Area' : 'Add Area'}</Card.Title>
                    </Card.Header>
                    <Card.Body>
                        {
...
export default connect(mapStateToProps, mapActionsToProps)(MaintainAreaMaster)
