...
const RoomMaster = (props: IMasterProps) => {
    ...
    const redirectToMaintainUser = (Id: number) => {
        ...
        history.push('/maintain-room');
    }

    const approve = (Id: number) => {
        dispatch(approveMaster('room', Id));
    }
    ...
    return (<>
        <Row>
            <Col>
                <Card>
                    <Card.Header>
                        <Card.Title as="h5">Room</Card.Title>
                        <div className="card-header-right p-1" style={{ 'cursor': 'pointer' }}>
                            {canAddEdit ?
                                <Button variant="success" className="btn-sm btn-round has-ripple" onClick={() => redirectToMaintainUser(-1)}>
                                    <i className="feather icon-plus" /> Add Room
                                </Button>
                                : null
                            }
                        </div>
