...
export enum RoomActionTypes {
    ...
    EDIT_BATCHSIZE_INIT = 'EDIT_BATCHSIZE_INIT',
    EDIT_BATCHSIZE_SUCCESS = 'EDIT_BATCHSIZE_SUCCESS',
    EDIT_BATCHSIZE_FAILED = 'EDIT_BATCHSIZE_FAILED',
}
...
export enum MasterActionTypes {
    ...
    DELETE_MASTER_INIT = 'DELETE_MASTER_INIT',
